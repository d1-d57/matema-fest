...
// Миграция v30 → v31, 2026-05-10T22:35:49.238015Z. Унификация модели данных.
// Старая схема: applications + events + exhibits + 3 источника статуса.
// Новая схема: cards с единым полем status. См. journal.md.
window.FESTIVAL_DATA = {
  "_meta": {
    "version": "2026-05-11-v31-cards-unification",
    ...
    "last_modified": "2026-05-10T22:35:49.238015Z",
    "modified_by": "migration-v30-to-v31",
    ...
    "changes_v31": "Унификация модели данных. applications + events + exhibits → одна таблица cards. Единый статус карточки: new/considering/accepted/rejected (вместо трёх параллельных носителей). event.status (confirmed/tentative/placeholder) удалено как избыточная ось. Категории workshop+experiment объединены в station. Со слота удалены subcategory и apollo_slot — оба теперь только на карточке."
  },
  "venues": {
    "library": {
  ...
  "categories": {
    ...
    "station": {
      "display": "станции",
      "size": "big",
      "comment": "воркшопы, эксперименты, интерактивные станции — что-то делать руками и наблюдать"
    },
    "social": {
      "display": "общение",
      "size": "big",

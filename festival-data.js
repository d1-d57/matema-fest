...
// Автоматически сгенерировано programmer-tool 2026-05-17T00:11:36.937Z
window.FESTIVAL_DATA = {
  "_meta": {
    ...
    "last_modified": "2026-05-17T00:11:36.931Z",
  ...
  "cards": [
    ...
    },
    {
      ...
      "description": "Раскраски плоскости и связанные с этим сюжеты — направление, в котором Андрей давно работает. Точную тему уточним ближе к фестивалю.",
      "venue": "main_stage",
      "links": [
        {
          "label": "Wiki МФТИ",
    ...
    },
    {
      ...
      "description": "Поговорим о том, как яркие математические теории объясняют природу: как фракталы связаны с моделированием экосистем и откуда математики знают, как раскрашен тигр. Александра специально придумала эту лекцию для нашего фестиваля.",
      "venue": "main_stage",
      "links": [
        {
    ...
    },
    {
      ...
      "description": "Трёхмерный объект — рекурсивная агрегация икосферических узлов. Структура колеблется между дискретной геометрией и непрерывной формой. Это не модель чего-либо конкретного — это модель самого процесса организации формы, где красота возникает из логики роста.",
      "_source_app": "app-12",
      "application": {
        "_suggested_category": "art",
        "_suggested_subcategory": "installation",
    ...
    },
    {
      ...
      "description": "Ковёр с QR-кодами из серии «Детские иллюзии». Серия посвящена орнаментам из советского обихода — обои, ковры, паркеты, плитка. Если долго в них всматриваться, они оживают: начинают шевелиться, искажаются, превращаются в персонажей. На фестивале мы повесим ковёр, и через камеру телефона можно будет анимировать его отдельные части.",
      "_source_app": "app-18",
      "application": {
        "_suggested_category": "art",
        "_suggested_subcategory": "installation",
    ...
    },
    {
      ...
      "subtype": "art",
      "apollo_slot": "big-2",
      "title": "Фрактал в современном искусстве",
      "speaker": "Ирина Богатикова (куратор)",
      "description": "Мини-выставка работ современных художников, которые работают с темами сакральной геометрии, орнамента, повторяющихся структур и фрактальной эстетики. В одной точке собрано несколько разных взглядов на то, как математические идеи становятся визуальным языком.",
      "_source_app": "app-34",
      "application": {
        "_suggested_category": null,
        "_suggested_subcategory": null,
    ...
    },
    {
      ...
      "subtype": "art",
      "apollo_slot": "big-3",
      "title": "Лентикулярная печать",
      "speaker": "Художник (контакт через знакомого)",
      "description": "Несколько работ с фракталами, напечатанных в лентикулярной технике. Лентикуляры дают объёмный, меняющийся при разном угле взгляда эффект — фрактал начинает жить и двигаться. Работы вывесим на улице у клуба."
    },
    {
      "id": "app-22",
      "status": "considering",

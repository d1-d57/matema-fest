...
// Автоматически сгенерировано programmer-tool 2026-05-14T14:47:18.979Z
window.FESTIVAL_DATA = {
  "_meta": {
    ...
    "last_modified": "2026-05-14T23:23:27.000Z",
    "modified_by": "phase9-descriptions-batch",
  ...
  "cards": [
    ...
    },
    {
      ...
      "description": "С помощью простых локальных замен подграфов можно получить\nне только тьюринг-полную систему перезаписи, но и красивые\nкартины на грани с искусством — в том числе фракталы. Александр\nпокажет визуализации и расскажет, как связаны графовые\nпереписи, конечные автоматы, физический проект Вольфрама и\nлямбда-исчисление.",
      "_source_app": "app-22",
      "application": {
    ...
    },
    {
      ...
      "description": "«Пи» — первый полнометражный фильм Даррена Аронофски («Чёрный\nлебедь», «Фонтан», «Кит»), чёрно-белый психологический триллер\n1998 года, получивший премию Сандэнса за лучшую режиссуру. Герой\nфильма, математик, ищет универсальный код, объясняющий всё:\nи биржу, и листья деревьев, и древние тексты.",
      "slot": "slot-cinema-2",
      "venue": "library"
    },
    {
    ...
    },
    {
      ...
      "description": "Частный детектив Мэнни Брот решает головокружительные\nгеометрические загадки. Готовьтесь к раскрытию дела о пропавших\nфракталах.",
      "venue": "main_stage"
    },
    {
    ...
    },
    {
      ...
      "slot": "slot-music-1",
      "venue": "main_stage",
      "description": "Пётр Термен — один из ведущих исполнителей на терменвоксе в мире,\nкомпозитор, правнук Льва Термена, изобретателя инструмента.\nРуководит Russian Theremin School, со-основатель петербургского\nобщества терменвокса. В 2019 году участвовал в мировом рекорде —\nоркестре из 289 терменвоксов в Кобе, который исполнил «Оду к\nрадости» Бетховена."
    },
    {
      "id": "music-main-23",
      "status": "accepted",
      ...
      "slot": "slot-music-2",
      "venue": "main_stage",
      "description": "Электронный артист из Москвы. Релизы — Space Odyssey, Radio\nHimalaya, Play In Alkotrazz. Прямого авто-описания у Stropharia\nнет — пусть будет коротко: космическая электроника на стыке\nэмбиента и танцевальной музыки."
    },
    {
      "id": "music-main-00",
      "status": "accepted",
      ...
      "slot": "slot-music-3",
      "venue": "main_stage",
      "description": "Роман Вороновский, музыкант, продюсер, перформер и видеохудожник\nиз Жуковского. Основатель проектов Rombix, Forhazis, Bad Fingerz\nCellofano и лейбла 24919. Исследователь процессов плёночной\nзвукозаписи и манипуляций с лентой. Собиратель старой аналоговой\nаппаратуры, брошенных аудионосителей, артефактов из радиоэфиров\nи полевых записей. Первое выступление Rombix состоялось в 2006\nгоду в московском клубе «Ротонда»."
    },
    {
      "id": "music-main-01",
      "status": "accepted",
      ...
      "slot": "slot-music-5",
      "venue": "main_stage",
      "description": "WOMBA — сольный проект Тихона Кубова, существует с 1995 года.\nВырос из домашних манипуляций с плёнками, петлями, семплами и\nнайденными звуками. Поздние записи — онирические звуковые\nколлажи и импровизированные перформансы с упором на абсурд,\nпсихоз и случайность. Кубов также участник проектов Won James\nWon и Goon Gun, записывает всё в своей студии BZDOK в Москве."
    },
    {
      "id": "music-main-02",
      "status": "accepted",
    ...
    },
    {
      ...
      "venue": "big_bar",
      "description": "К фестивалю Brinstaar готовит специальный сетап: звук генерируется\nпроцедурными алгоритмами, в том числе на основе фракталов."
    },
    {
      "id": "music-pink-2230",
      "status": "accepted",
    ...
    },
    {
      ...
      "venue": "big_bar",
      "description": "По собственному определению Morakh, жанр, который лучше всего\nописывает его музыку, — Urban Techno. Со страницы лейбла:\n«Он точно схватывает хтоническую реальность российских городов,\nстрашную и абсурдную, но безусловно идиосинкратическую, и\nодновременно передаёт шаманскую, примитивную гармонию\nнебесных сфер. Сакральная грусть Питера Гэбриэла встречается\nс заводом Орджоникидзе и недокормленными воробьями из парка\nТалалихина»."
    },
    {
      "id": "music-pink-0030",
      "status": "accepted",
    ...
    },
    {
      ...
      "venue": "big_bar",
      "description": "Экспериментальный проект из Москвы, родом из Каширы. Электро\nи минимал-техно с примесями даба, IDM, эмбиента, регги. Артист\nведёт свой лейбл KILL EGO, выпустил больше десяти релизов\nс 2007 года."
    },
    {
      "id": "music-pink-0230",
      "status": "accepted",

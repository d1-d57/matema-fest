...
window.FESTIVAL_DATA = {
  "_meta": {
    ...
    "changes_v33": "Художественная программа. Удалены inst-mimesis (Мимесис) и exh-bogatikova-mini (Фрактал в современном искусстве). Добавлены 4 новых art-карточки: art-monads-mirrors (Монады — зеркала души, А. Алеф Вайсман, art/art, big-2), inst-anthill-sierpinski (Муравейник Серпинского, арт-дуэт EVPRAXIS, art/installation, big-3), media-cactus-juice (Cactus Juice, art/media, big-3), media-fractal-reflection (Фрактальное Отражение, Артём Ткач, art/media, mid-1). Имена дополнены/исправлены: art-plato + Солеев в описании, art-other-spaces + Петра в описании, inst-element1 speaker «Ира» → «Ирина Канделариа», inst-tetraquark speaker «Alex Mu» → «Алекс Мухин», inst-polyhedral-exhibit speaker «Максимилиан» → «Максимилиано» и встроено в описание. Музыка: music-main-22 title «Сет Петра Термена» → «Пётр Термен». Подзаголовок subcategories.art.installation.display «инсталляции» → «объекты». В index.html подзаголовок категории Музыка «DJ-сеты в течение всего дня» → «live-выступления». Остаются ждать готового текста: music-rap (научно-технический рэп / Влад Горелов) и описание inst-element1."
  },
  "venues": {
    "library": {

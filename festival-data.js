...
window.FESTIVAL_DATA = {
  "_meta": {
    ...
    "last_modified": "2026-05-15T12:20:59.000Z",
    "modified_by": "phase12-descriptions-final",
  ...
  "cards": [
    {
      ...
      "description": "Открывающая лекция фестиваля — введение в тему. Расскажем, что\nтакое фракталы, как они устроены, и покажем, где их можно найти:\nв природе, в искусстве, в математике, в нашей повседневной\nжизни. Эта лекция задаёт тон всему, что будет происходить на\nфестивале дальше."
    },
    {
      "id": "talk-evdokimov",
      "status": "accepted",
      ...
      "description": "Утром в библиотеке Достоевского Михаил даст задачи, которые можно\nрешить без знания математики — глядя на картинку. Их можно решать\nвслух, можно молча, можно с детьми и без.",
      "slot": "slot-evdokimov",
      "venue": "library",
      "_admin": {
        "knows": true,
    ...
    },
    {
      ...
      "description": "Утренняя часть программы в библиотеке Достоевского. Командный\nквиз в формате ЧГК с вопросами на стыке науки и искусства.\nИграть можно семьями, с детьми, школьниками — или без них.",
    ...
    },
    {
      ...
      "description": "Сеанс знакомств, построенный по принципу фрактала: сначала\nучастники представляются в парах, потом пары соединяются в\nчетвёрки, четвёрки в группы по восемь, восемь в шестнадцать.\nНа каждом этапе ищут общий паттерн между собой, сохраняют его\nили меняют. К концу часа группы из шестнадцати человек собирают\nкарту своих связей — каждый уходит с контактами всех, с кем\nуспел познакомиться.",
    ...
    },
    {
      ...
      "description": "Ясно, что пять яблок больше, чем три яблока. Но вот можно ли\nсказать, каких чисел больше: чётных или нечётных? чётных или\nнатуральных? целых или рациональных дробей? Как вообще\nсравнивать бесконечности? Или они все одинаковы?",
      "slot": "slot-gelfand",
      "venue": "main_stage",
      "_admin": {
        "knows": true
    ...
    },
    {
      ...
      "description": "Лекция Андрея будет про раскраски плоскости и связанные с этим\nсюжеты — это направление, в котором он давно работает. Точную\nтему уточним ближе к фестивалю.\n\n---\n\n# Социальные",
    ...
    },
    {
      ...
      "description": "Поговорим о том, как яркие математические теории объясняют\nприроду: как фракталы связаны с моделированием экосистем\nи откуда математики знают, как раскрашен тигр. Александра\nспециально придумала эту лекцию для нашего фестиваля. Я слышал\nрасширенный анонс, и это дико интересно. Ради ее одной уже стоит\nприйти.",
    ...
    },
    {
      ...
      "description": "Многие видели книги с выдвижными иллюстрациями. Оказывается,\nможно создать раскладывающуюся открытку с фракталом в технике\npop up. На мастер-классе участники смогут прочувствовать, что\nтакое самоподобие и сделать свои собственные трехмерные модели\nфракталов.",
    ...
    },
    {
      ...
      "description": "Японская каллиграфия — фрактальная: каждая черта повторяет форму\nцелого иероглифа, и каждый штрих неповторим. Возьмём кисть и тушь,\nпопробуем сами — без задачи «сделать красиво», с задачей\nпрочувствовать, как одно движение разворачивается в форму.",
    ...
    },
    {
      ...
      "speaker": "Полина Романова",
      "description": "Соберём подвижные модели солнечных панелей в технике оригами:\nпо чертежу, со сборкой и инструкцией. Складные конструкции из\nбумаги работают по строгим математическим правилам, поэтому\nих применяют в инженерии — от солнечных батарей до медицинских\nстентов.",
    ...
    },
    {
      ...
      "speaker": "Ольга",
      "description": "Техника «Космические яйца»: складываем ткань определённым образом,\nстягиваем вощёной нитью и заливаем кипятком с красителями. Через\nполчаса разворачиваем — получается фрактальный узор, который\nникогда не повторится.",
    ...
    },
    {
      ...
      "description": "Терменвокс — электромузыкальный инструмент, который сто лет\nназад изобрёл в Петербурге Лев Термен. Музыкант играет руками\nв воздухе, не касаясь инструмента. Лора расскажет, как это\nустроено физически, и даст попробовать всем, кто захочет.\nПодготовки никакой не нужно — приходите и пробуйте.",
    ...
    },
    {
      ...
      "speaker": "Ася",
      "description": "Рисуем витражные краски по гибкому пластику. По линиям и формам\nполучается фрактальный узор — каждый забирает свою работу с\nсобой.",
    ...
    },
    {
      ...
      "description": "Единственная группа в России, играющая нердкор — интеллектуальный\nхип-хоп. Песни — про реалии жизни IT-специалистов, биографии\nучёных и популярные теоремы. Влад программист, в прошлом\nсотрудник теорсектора Ландау. Группа основана в 2014 году «с\nцелью нести свет знания в небытие хип-хопа».",
    ...
    },
    {
      ...
      "description": "Татьяна занимается фрактальными замощениями — это её основная\nнаучная работа на мехмате. На станции можно выбрать форму\nфрактала и цветовую гамму, программа сгенерирует замощение,\nа маленький термопринтер тут же напечатает результат. Получается\nперсональный паттерн — можно унести с собой, можно отправить\nфайлом и потом напечатать на чём угодно.",
    ...
    },
    {
      ...
      "description": "Музыкальный спектакль по тексту Хармса «Нуль и ноль». Алина\nплетёт звуковую среду в реальном времени, в зале — физический\nобъект-нуль, к которому зритель может прикоснуться. Каждое\nприкосновение включает свой звуковой эффект, спектакль реагирует\nна действия зала. Можно ничего не делать — спектакль всё равно\nидёт сам.",
    ...
    },
    {
      ...
      "description": "Лайв-подкаст о фракталах на границе математики и философии.\nПростое итеративное правило, заданное на конечной плоскости,\nпорождает структуру с бесконечной длиной, бесконечной глубиной,\nсамоподобием на всех масштабах. Это математический факт. Но\nбесконечное в конечном — это содержательное утверждение об\nустройстве мира или удобная метафора нашего масштабирования?\nКогда мы вычисляем множество Мандельброта — мы открываем\nсуществующее, конструируем новое или описываем структуру\nсобственного познания? Состав участников будет объявлен.\n\n---\n\n# Кино",
    ...
    },
    {
      ...
      "description": "Сначала построим дерево Пифагора и попробуем понять, конечна ли\nего площадь. Затем с помощью циркуля и формулы Декарта достроим\nковёр Аполлония, обсудим его раскраски и связь с цепными дробями.\nБудем работать руками — и разбираться, как фракталы устроены.",
      "slot": "slot-cinema-2",
      "venue": "library"
    },
    {
      ...
      "description": "Цифровой художник из Нидерландов. Делает завораживающие\nфрактальные анимации, в которых математическая сложность\nвстречается с кинематографической красотой.",
      "venue": "main_stage"
    },
    {
      ...
      "description": "«Эти миры существовали всегда, Machina Infinitum интерпретирует\nих, позволяя вам их познать».",
      "venue": "main_stage"
    },
    {
      ...
      "description": "Как оплакивать потерю того, чего у тебя никогда не было? Грейс\nживёт воспоминаниями и мечтами о том, что могло бы случиться —\nпосле потери того, чего у неё никогда и не было.",
      "venue": "main_stage"
    },
    {
      ...
      "apollo_slot": "mid-1",
      "title": "Fractal baby",
      "description": "Маленькая девочка разговаривает с младенцем, который ещё в\nживоте у матери. Она перечисляет ему все причины, по которым\nему стоит выйти наружу.",
      "venue": "main_stage"
    },
    {
      ...
      "description": "Анимация по проекту «Атлас человека» Брайана Альвареса из\nКалифорнийского университета в Беркли. Иллюстрация его идеи\nо красоте живых организмов.",
      "venue": "main_stage"
    },
    {
      ...
      "description": "Аудиовизуальное исследование пространства, времени,\nразмерности, геометрии, сознания и биоразнообразия.",
      "venue": "main_stage"
    },
    {
      ...
      "description": "Фильм основан на последнем интервью Бенуа Мандельброта,\nзаписанном в 2010 году за 19 дней до его смерти. Отец фракталов\nвспоминает свой путь в математике и рассказывает, как его взгляд\nна мир привёл к открытию фрактальной геометрии.",
    ...
    },
    {
      ...
      "description": "Карл Менгер встречает Гюстава Эйфеля в машине времени.\nБесконечное путешествие на разных скоростях и в разных\nнаправлениях — фильм показывает его на разных уровнях\nодновременно.\n\n---\n\n# Станции и мастерские",
    ...
    },
    {
      ...
      "speaker": "Пётр Термен",
      "description": "Пётр Термен (Peter Theremin) — один из ведущих исполнителей на\nтерменвоксе в мире, академический и электронный музыкант,\nруководитель школы терменвокса ThereminFamilySchool, правнук\nЛьва Термена. Как композитор — лауреат премий Creativepool и\nClio Music.",
      "slot": "slot-music-1",
      "venue": "main_stage"
    },
    {
      ...
      "apollo_slot": "big-2",
      "title": "Stropharia",
      "description": "Московский live-проект, сформирован Дмитрием Поликарповым в 1993\nгоду на волне увлечения индустриальной культурой, психоделической\nэлектроникой и трансгрессивной стороной рейв-сцены. За три\nдесятилетия многое изменилось, но самое важное осталось: умная\nэлектроника, радикальный бит, цифровой хардкор, эйсид-транс и\nнеизменная харизма выступающего. Выступление поддержит\nвидео-арт-художник vj forrrest.",
      "slot": "slot-music-2",
      "venue": "main_stage"
    },
    {
      ...
      "apollo_slot": "mid-1",
      "title": "Rombix",
      "description": "Роман Вороновский — музыкант, продюсер, артист-перформер и\nвидео-художник. Основатель проектов Rombix, Forhazis, Bad Fingerz\nCellofano, Forhazis Penoplastik Diskotek и лейбла 24919.\nЭнтузиаст-исследователь процессов плёночной звукозаписи и\nпоследующих манипуляций с лентой, собиратель старой аналоговой\nаппаратуры, брошенных аудионосителей, артефактов из радиоэфиров\nи полевых записей. Шелест плёночных петель, спонтанные\nвмешательства в характер их воспроизведения и непредсказуемое\nналожение звуков друг на друга порождают колышущийся и\nпостоянно меняющийся поток, в котором меняется восприятие\nпространства и времени.",
      "slot": "slot-music-3",
      "venue": "main_stage"
    },
    {
      ...
      "apollo_slot": "mid-2",
      "title": "Womba",
      "description": "Сольный проект Тихона Кубова, участника многих мультижанровых\nформаций (Won James Won, J-Lobster, Pententacles). Альбомы WOMBA\nс середины нулевых выходят на разных андерграундных лейблах —\nR.A.I.G., CANT, Industrial Coast, Orgone Dealers, Cancelled\nRecords. Звуковые конструкты WOMBA построены на заботливо\nдеформированных кассетных и полевых сэмплах, полуразложившихся\nhome-fi гармониях, конвульсивных синтетических вибрациях. В\nживой интерпретации этот звуковой бульон обильно сдабривается\nнеудобоваримыми вокальными специями и дерзкими экзерсисами с\nпротиворечащими разумным доводам эффектами.",
      "slot": "slot-music-5",
      "venue": "main_stage"
    },
    {
      ...
      "apollo_slot": "big-3",
      "title": "Hobboth",
      "description": "Эмбиент-проект, вдохновлённый земным и космическим воплощениями\nприроды. Мелодические секвенции наслаиваются друг на друга и\nплавно переходят в шумы и дроны.",
      "slot": "slot-music-6",
      "venue": "main_stage"
    },
    {
      ...
      "apollo_slot": "mid-1",
      "title": "Brinstaar",
      "description": "Проект московского художника, музыканта и дизайнера Михаила\nМясоедова. Существует с 2006 года, работает с импровизацией и\nспонтанным сочинением. Михаил — соучредитель российского лейбла\nKotä, ориентированного на открытие новых границ авангардной\nмузыки. Преподаёт саунд-арт и саунд-дизайн в Школе дизайна НИУ\nВШЭ, делает звук для спектаклей, инсталляций, аудиокниг и\nподкастов, работал с ГЭС-2, Третьяковкой, MMOMA, Яндексом,\nСбербанком. К фестивалю готовит специальный сетап, в котором\nзвук генерируется процедурными алгоритмами, в том числе на\nоснове фракталов.",
    ...
    },
    {
      ...
      "apollo_slot": "big-2",
      "title": "Spiralfractal",
      "description": "В основе проекта — спиральность и фрактальность всего сущего.\nВо время его выступления архаичные ритмы, этнические мелодии\nи басовые волны формируют на танцполе узоры сакральной геометрии.",
    ...
    },
    {
      ...
      "apollo_slot": "mid-2",
      "title": "Morakh",
      "description": "Резидент лейблов «Местность» и Shelter Tapes. Звучание проекта\nMorakh — синтез интеллигентного техно, брейкбита, IDM и future\ngarage, энергичная и эмоциональная музыка для больших площадок.\nЕго альбомы сравнивали с работами Moderat, Bicep и Overmono.",
    ...
    },
    {
      ...
      "apollo_slot": "mid-3",
      "title": "ænsof",
      "description": "В каббалистической традиции есть непознаваемая сущность Б-га,\nдословно — «бесконечное». Дуэт использует абсолютно современный\nинструментарий, но, не размениваясь в своём звуке на сиюминутные\nвеяния моды, исследует сквозь призму классических индустриальных\nи дабовых техник полубессознательные и порой архетипические\nобразы.",
    ...
    },
    {
      ...
      "apollo_slot": "big-3",
      "title": "garish_cyborg",
      "description": "Московский экспериментатор, работающий в разных жанрах — от\nгипнотического дабстепа до самых шумных форм индастриала.\nОснователь лейблов KILL EGO, «Бегущий Человек», «Такое».",
    ...
    },
    {
      ...
      "description": "Дискотека под шумы. Витчхаус и нойз, дрон и брейкбит — создатель\nпроекта стирает рамки между стилями, приводя их к общему\nзнаменателю — музыке как таковой.",
    ...
    },
    {
      ...
      "speaker": "Стас",
      "description": "Станция с экспериментами, которые можно потрогать руками. В этом\nгоду у Стаса магистральная линия — от спектроскопии и химии к\nквантовой механике. Идея простая: показать, как обычные опыты\nоткрывают свою квантовую природу, и дать прикоснуться к\nквантовой механике руками.",
    ...
    },
    {
      ...
      "speaker": "Анастасия",
      "description": "Наноматериалы состоят из элементарных ячеек — самой маленькой\nповторяющейся части. На станции можно изучить срезы разных\nнаноматериалов и попробовать найти элементарную ячейку самому,\nпо разным уровням сложности. Рядом — напечатанная на 3D-принтере\nструктура двухслойного графена, которую можно поворачивать\nруками.",
      "slot": "slot-stations-3-2",
      "venue": "small_bar",
      "lane": "right",
      "_admin": {
    ...
    },
    {
      ...
      "description": "Екатерина — science-art-художник, который вокруг морской биологии\nвыстраивает интересные визуальные сюжеты. Раковины, аммониты,\nкораллы — почти все формы морской жизни фрактальны, и фестиваль —\nповод их рассмотреть подробнее. Формат станции уточняется.\n\n---\n\n# Арт-объекты",
    ...
    },
    {
      ...
      "description": "Партнёрское выступление: 15 минут о том, как фракталы возникают в обучающихся нейросетях.",
    ...
    },
    {
      ...
      "speaker": "Вячеслав Гусев",
      "description": "Партнёрский стенд: визуализации хаотических процессов обучения нейросетей.",
    ...
    },
    {
      ...
      "description": "Может ли наша вселенная быть фрактальной? Может ли простая\nматематика создать целую вселенную? Что общего у брокколи с\nБольшим взрывом? И при чём здесь видеоигры No Man's Sky и\nMinecraft?"
    },
    {
      ...
      "title": "FracLife",
      "speaker": "Юля",
      "description": "Интерактивная видеоинсталляция: на экране оживают фракталы,\nк ним идёт звук. Двигаешь руками — меняется количество итераций,\nтип фрактала, можно углубиться в структуру или деформировать\nизображение. Работает на ноутбуке с камерой — порог входа\nнулевой.",
      "links": [
        {
          "label": "из заявки",
    ...
    },
    {
      ...
      "speaker": "Андрей",
      "description": "На сайте Андрея можно играть с фракталами, шумом и другими\nматематическими объектами — и собирать собственные. Андрей\nпокажет, как этим пользоваться, и расскажет, как из простых\nформул рождается визуальная красота.",
      "links": [
        {
          "label": "из заявки",
    ...
    },
    {
      ...
      "description": "Серия видеоработ, сделанная для «Фрактальной Одиссеи». Я давно\nслежу за «Явью» и могу сказать одно: их работы хочется смотреть\nдолго.",
      "_source_app": "app-28",
      "application": {
    ...
    },
    {
      ...
      "speaker": "Alex Mu",
      "description": "Скульптурная интерпретация физической частицы, очарованного\nтетракварка. Имя кварка отсылает к букве T, форма работы вырастает\nиз этой буквы. Внутри объекта зашито самоподобие — символ внутри\nсимвола, структура внутри структуры.",
      "_source_app": "app-4",
      "application": {
        "_suggested_category": "art",
    ...
    },
    {
      ...
      "description": "Трёхмерный объект — рекурсивная агрегация икосферических узлов.\nСтруктура колеблется между дискретной геометрией и непрерывной\nформой. Это не модель чего-либо конкретного — это модель самого\nпроцесса организации формы, где красота возникает из логики\nроста.",
      "_source_app": "app-12",
      "application": {
        "_suggested_category": "art",
        "_suggested_subcategory": "installation",
    ...
    },
    {
      ...
      "title": "Элемент 1",
      "speaker": "Ира",
      "description": "Объект-инсталляция из серии «Элементы» — про рекурсию и\nсамоподобие. Каждая работа задумана как начальная точка, из\nкоторой могут вырасти следующие, как из исходного фрагмента\nвырастает фрактал.",
      "_source_app": "app-13",
      "application": {
        "_suggested_category": "art",
        "_suggested_subcategory": "installation",
    ...
    },
    {
      ...
      "description": "Ковёр с QR-кодами из серии «Детские иллюзии». Серия посвящена\nорнаментам из советского обихода — обои, ковры, паркеты, плитка.\nЕсли долго в них всматриваться, они оживают: начинают шевелиться,\nискажаются, превращаются в персонажей. На фестивале мы повесим\nковёр, и через камеру телефона можно будет анимировать его\nотдельные части.",
      "_source_app": "app-18",
      "application": {
        "_suggested_category": "art",
        "_suggested_subcategory": "installation",
    ...
    },
    {
      ...
      "description": "Серия скульптур, в которых живые природные формы переплетаются\nс техногенными. Александр давно ведёт проект «Плато» — это\nискусственный мир, где он эмулирует и визуализирует процессы\nразвития искусственной жизни. Иногда на Плато удаётся захватить\nформу и перенести её в наш мир — в керамику, гипс, искусственный\nкамень. Эти артефакты и привозит на фестиваль.",
      "_source_app": "app-7",
      "application": {
        "_suggested_category": "art",
    ...
    },
    {
      ...
      "description": "Каждая картина Николаева — это фрагмент фрактала, бесконечной\nматематической структуры, выросшей из простой формулы. И каждая\nкартина — это фрагмент целого мира, в котором можно было бы\nвыхватить любое другое место."
    },
    {
      ...
      "description": "Мини-выставка работ современных художников, которые работают с\nтемами сакральной геометрии, орнамента, повторяющихся структур\nи фрактальной эстетики. В одной точке собрано несколько разных\nвзглядов на то, как математические идеи становятся визуальным\nязыком.",
      "_source_app": "app-34",
      "application": {
        "_suggested_category": null,
        "_suggested_subcategory": null,
    ...
    },
    {
      ...
      "description": "Несколько работ с фракталами, напечатанных в лентикулярной\nтехнике. Лентикуляры дают объёмный, меняющийся при разном угле\nвзгляда эффект — фрактал начинает жить и двигаться. Работы\nвывесим на улице у клуба."
    },
    {
      "id": "app-22",
      "status": "considering",
    ...
    },
    {
      ...
      "slot": "slot-cinema-1",
      "venue": "library",
      "description": "Второй кинопоказ фестиваля — документальный фильм про фракталы. Название и подробности уточним ближе к дате."
    }
  ],
  "fern_leaves": [
    {
